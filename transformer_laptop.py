...
class Encoder(nn.Module):
    def __init__(self, src_vocab_size, embed_size, num_layers, heads,
        ...
        # max length : maximum length of the longest sentence
...
class Decoder(nn.Module):
    ...
    def forward(self, x, enc_out, src_mask, trg_mask):
        ...
        x = self.dropout(self.word_embedding(x) + self.position_embedding(postions))
...
if __name__ == "__main__":
    ...
    x = torch.device([[1,5,6,4,3,9,5,2,0], [1,8,7,3,4,5,6,7,2]]).to(device)
